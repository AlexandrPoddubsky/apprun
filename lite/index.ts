...
import { createElement, render } from '../vdom-my';
...
app.render = render;
app.on('set_createElement', createElement => app.createElement = createElement);
app.on('set_render', render => app.render = render);
